...
public class SecurityUtils
{
    ...
    public static Integer getUserId()
    {
        ...
        {
            throw new ServiceException("获取用户ID异常", NetdiskErrMsgConstant.UN_AUTHENTICATED);
        }
    }
    ...
    public static String getUsername()
    {
        ...
        {
            throw new ServiceException("获取用户账户异常", NetdiskErrMsgConstant.UN_AUTHENTICATED);
        }
    }
    ...
    public static LoginUser getLoginUser()
    {
        ...
        {
            throw new ServiceException("获取用户信息异常", NetdiskErrMsgConstant.UN_AUTHENTICATED);
        }
    }
